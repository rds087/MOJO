...
public class QuickStart9eHotlink extends JFrame {
	...
	JButton hyperlink_button = new JButton(new ImageIcon(
			"Pics/hyperlink_icon.gif"));
	...
	// java.awt.Cursor boltCursor = tk.createCustomCursor(bolt,new
	// java.awt.Point(6, 30), "bolt");
	...
	class PicAdaptorForHyperLink implements PickListener { // implements hotlink
		...
		public void foundData(PickEvent pe) {
			...
			try {
				/*
				 * HotPick hotpick = new HotPick();// opens dialog window with
				 * Duke // in it hotpick.setVisible(true);
				 */
				if (Desktop.isDesktopSupported()) {
					Desktop.getDesktop().browse(
							new URI(hyperLinkMap.get(mystate)));
				}
			} catch (Exception e) {
			}
		}
	...
	public void PopulateHyperLinkMap() {
		...
		hyperLinkMap.put("San Jose", "http://sikhgurudwarasj.org/");
		hyperLinkMap.put("Florida", "http://www.gurdwarananaksarflorida.com/");
		hyperLinkMap.put("Chicago", "http://www.srsofchicago.com/");
		hyperLinkMap.put("Indianapolis",
				"http://indianapolisgurdwara.org/sikh/");
		hyperLinkMap.put("Massachusetts", "http://www.gurunanakdarbar.net/");
		hyperLinkMap.put("Michigan", "http://www.michigangurudwara.com/");
		hyperLinkMap.put("Louis", "http://www.gurdwarastlouis.org/");
		hyperLinkMap.put("Charlotte", "http://charlottegurdwara.org/");
		hyperLinkMap.put("Nevada", "http://www.worldgurudwara.com/V4/483.asp");
		hyperLinkMap.put("New Jersey", "http://www.nnjgurudwara.com/");
		hyperLinkMap.put("New York",
				"http://plainview-gurudwara.appspot.com/html/index.html");
		hyperLinkMap.put("Ohio", "http://clevelandgurudwara.org/");
		hyperLinkMap.put("Houston", "http://www.gurudwarasahibhouston.com/");
		hyperLinkMap.put("Vancouver", "http://www.gururamdassgurudwara.org/");

		hyperLinkMap.put("Renton", "http://www.singhsabhaseattle.com/");
		hyperLinkMap.put("Bothell", "http://www.sikhcentreofseattle.org/");
		hyperLinkMap.put("San Antonio",
				"http://www.sikhcenter.us/gur/index.php");
		hyperLinkMap.put("Los Angeles", "http://www.lankershimgurdwara.com/");
		hyperLinkMap.put("San Diego", "http://www.sdsikhs.org/");
		hyperLinkMap.put("Albuquerque",
				"http://www.worldgurudwara.com/V4/301.asp");
		hyperLinkMap
				.put("Espanola",
						"http://www.sikhiwiki.org/index.php/Sikh_Dharma_International_Espanola");
		hyperLinkMap.put("Commerce City", "http://www.coloradosinghsabha.org/");
		hyperLinkMap.put("Louisville", "http://www.louisvillegurdwara.org/");
		hyperLinkMap.put("Minneapolis", "http://www.mnsikhs.com/");
		hyperLinkMap.put("Oklahoma City", "http://www.okcgurdwara.com/");
		hyperLinkMap.put("Millbourne",
				"http://www.worldgurudwara.com/V4/521.asp");
		hyperLinkMap.put("Richmond",
				"http://pingakshotechnologies.com/richmond/");
		hyperLinkMap.put("Taylorsville", "http://www.sikhtempleofutah.com/");
		hyperLinkMap.put("Salem", "http://www.salemgurdwara.com/");
		hyperLinkMap.put("Wisconsin", "http://srsofwi.org/");
		hyperLinkMap.put("West Des Moines",
				"https://www.sikhinc.org/wordpress/");
		hyperLinkMap.put("Olathe", "http://www.kcsikh.org/");
		hyperLinkMap.put("Durham", "http://www.sgncweb.org/");
		hyperLinkMap.put("Roswell", "http://www.sewageorgia.org/");
	}
	...
	private void jbInit() 
	{
		...
		map.addMouseMotionListener(new MouseMotionAdapter() {
			public void mouseMoved(MouseEvent me) {
				...
				if (map.getLayerCount() > 0) {
					worldPoint = map
							.transformPixelToWorld(me.getX(), me.getY());
		...
		hotjb
				.setToolTipText("hotlink tool--click somthing to maybe see a picture");
		...
		helpjb
				.setToolTipText("left click here, then right click on a tool to learn about that tool");
		jtb.add(XYjb);
		jtb.add(helpjb);
